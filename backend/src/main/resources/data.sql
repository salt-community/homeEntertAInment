INSERT INTO public.rule_sets (file_size, created_at, coded_data, decoded_data, file_ext, file_name, clerk_user_id) VALUES
    (
        2150,
        ...
        'txt',
        'UNO Ruleset.txt',
        'user_338ZBr9iJtu7LwsZBjtDSHdArrk'
    );
INSERT INTO public.game_sessions (is_active, created_at, rule_set_id, game_name, game_state, clerk_user_id) VALUES (true, '2025-09-19 18:07:29.340606', 1, 'Uno', 'setup', 'user_338ZBr9iJtu7LwsZBjtDSHdArrk');
INSERT INTO public.game_players (created_at, session_id, player_name) VALUES ('2025-09-19 18:07:29.358845', 1, 'Aki');
INSERT INTO public.game_players (created_at, session_id, player_name) VALUES ('2025-09-19 18:07:29.363687', 1, 'Juan');
...
INSERT INTO public.game_sessions (is_active, created_at, rule_set_id, game_name, game_state, clerk_user_id) VALUES (true, '2025-09-22 12:34:56.000000', 2, 'Name Chain', 'playing', 'user_338ZBr9iJtu7LwsZBjtDSHdArrk');

INSERT INTO public.game_players (created_at, session_id, player_name) VALUES ('2025-09-22 12:34:56.000000', 2, 'Marta');
INSERT INTO public.game_players (created_at, session_id, player_name) VALUES ('2025-09-22 12:34:56.000000', 2, 'Carlos');
INSERT INTO public.game_players (created_at, session_id, player_name) VALUES ('2025-09-22 12:34:56.000000', 2, 'Sophie');
...
Warhammer 40,000 is a tabletop war game in which players command armies of Citadel miniatures and attempt to defeat their opponent through a mixture of skill, tactics and luck. Storytelling is at the core of Warhammer 40,000, with
the rules designed to bring to life the epic conflicts between the forces of Mankind, aliens and daemons in the grim darkness of the far future. The purpose of the game is for all players to have an enjoyable shared experience, putting their tactical skills to the test while admiring the spectacle of amazing miniatures clashing on fantastic battlefields. In this spirit, good sportsmanship and politeness are at the heart of the game.
Games of Warhammer 40,000 are won by scoring more Victory points than your opponent through achieving various objectives, from recovering vital relics
to capturing enemy strongholds or eliminating the opposing Warlord.
...
4 CHARGE PHASE
In a game as wide-ranging as Warhammer 40,000, there may be times when you are not sure exactly how to resolve a situation that has come up during play. When this happens, have
a quick chat with your opponent and apply the solution that makes the most sense to both of you (or seems the most fun!). If no single solution presents itself, you and your opponent should roll off, and whoever rolls highest gets to choose what happens. Then you can get on with the fighting!
...
DATASHEETS AND UNIT
ABILITIES
Many units in Warhammer 40,000 have one or more abilities listed on their datasheets that they can use in battle. Some of the most common of these are not written out in full on those datasheets, but are instead only referenced by name; the full details
of these can be found on the Core Rules pages ahead, marked with the symbol shown on the right.
HINTS AND TIPS
Some pages feature Hints and Tips, covering topics like dice-rolling practices and how to ensure you don’t damage
your models while

ABILITIES (PG 37-39)
Every Warhammer 40,000 unit has a datasheet, reflecting the characteristics and abilities they can draw upon
in battle.

STRATEGIC RESERVES AND
moving them around the battlefield. Note that these are not rules, they are simply pieces of advice you may find useful to apply to your own games.
SUMMARIES
...
Some rules on the pages ahead include bullet-pointed summaries for quick reference purposes. Note that these are not
comprehensive, and you should always consult the full rules if you are unsure.
...
PAGE NUMBERS
Throughout the Core Rules you will find page numbers shown within stylised triangles (see below). These function independently from any other page numbers within a publication; any page references found within the Core Rules – and any page references
to the Core Rules found elsewhere – are based on
this system, and do not 8
relate to any other page numbers outside of the Core Rules.
...
DATASHEETS
The rules you will need to use your models in games are presented on datasheets. Each unit has a datasheet;
...
In either case, keywords appear in Kᴇtwoʀd Bold. Keywords are sometimes linked to (or ‘tagged’ by) a rule. For example, a rule might say that it applies to Infanᴛʀt units. This means it
5 only applies to units that have the Infanᴛʀt keyword on their
datasheet. The pluralisation (or otherwise) of keywords does not affect which units the rule in question applies to.
...
At the end of every turn, each player must remove models, one at a time, from any of the units from their armies that are no longer in Unit Coherency, until only a single group of models from each of those

units remains in play and in Unit Coherency. Models removed in this way count as having been destroyed, but they never trigger any rules that apply when a model is destroyed.
...
2"
1½"
Each model in this Sternguard Veterans unit of five models is within 2" of at least one other model in the unit. This unit is therefore in Unit Coherency.
Each model in this Termagants unit of ten models is within 2" of at least two other models in the unit. This unit is therefore also in Unit Coherency.
...
MODEL FULLY VISIBLE
If every part of another model that is facing the observing model can be seen from any part of the observing model, then that other model is said to be fully visible to the observing model, i.e. the observing model
has line of sight to all parts of the other model that are facing it, without any other models or terrain features blocking visibility to any of those parts.
UNIT FULLY VISIBLE
If every model in a unit is fully visible to an observing model, then that unit is fully visible to that observing model. For the purposes of determining if an enemy unit is fully visible, an observing model
can see through other models in the unit it is observing.
...
Many gamers roll their dice somewhere on the battlefield, but some roll their dice elsewhere, such as in a dice tray. Wherever you roll your dice, make sure you roll the dice where your opponent can see the results too. If a dice is rolled out of bounds (i.e. it rolls off your battlefield, out of your dice tray
or ends up on the floor), it is very common to ignore the result of that dice and roll it again. Rolling an out-of-bounds dice again doesn’t count as having re-rolled that dice.
If a dice does not lie flat on your battlefield after it has been thrown, it is called a cocked dice. Some players use a house rule that unless a dice is flat after it has been rolled, or unless you can balance another dice on top of a cocked dice without it sliding
off, it must be rolled again. It is more common for players to roll the dice again only if they can’t be sure of the result. In any case, rolling a cocked dice again doesn’t count as having
re-rolled that dice.
...
RE-ROLLS
Some rules allow you to re-roll a dice roll, which means you get to roll some or all of the dice again. If a rule allows you to re-roll a dice roll that was made by adding several dice together (e.g.
2D6, 3D6, etc.) then, unless otherwise stated, you must re-roll all of those dice again.
...
2
1. COMMAND
At the start of your Command phase, before doing anything else, both players gain 1CP. Command points are a strategic
4 resource that you can spend during the battle to use Stratagems.
...
2. BATTLE-SHOCK
In this step, you must take a Battle-shock test for each of your units on the battlefield that is Below Half-strength (pg 12).
...
■ If a unit has a Starting Strength of 1, then it is said to be Below Half-strength while its remaining number of wounds is less than half of its
Wounds characteristic.
■ For any other unit, while the number of models in that unit is less than half of its Starting Strength, that unit is said to be Below Half-strength.
DESTROYED
Throughout a battle, models will suffer damage and be destroyed. When a model is destroyed, it is removed from the battlefield. When every model in a unit has been destroyed, that unit is destroyed.
ATTACHED UNITS
Some Cʜaʀaiᴛᴇʀ units have the Leader ability (pg 39), which lets them merge with other units (known as Bodyguard units) to form an Attached unit.
The Starting Strength of an Attached unit is equal to the combined Starting Strengths of all of its units (i.e. the number of models in the Leader unit added to the number of models in the Bodyguard unit). If either the Leader unit or the Bodyguard unit in an Attached unit is destroyed, the Starting Strength of the remaining unit
is changed to be equal to its original Starting Strength. 4
Example: A Primaris Captain (Starting Strength 1) is attached to a unit of Intercessors (Starting Strength 5). This Attached unit has a Starting Strength of 6. If all the Intercessors are destroyed, the remaining Primaris Captain would revert to having a Starting Strength
of 1.
...
Your Movement phase is split into two steps. First you can move your units, then you can set
5 up reinforcements.
1
MOVE UNITS
2
...
ADVANCE MOVES
When a unit Advances, make an Advance roll for that unit by rolling one D6. Add the result in inches to the Move characteristic of each model in that unit until the end of the phase. Each model in that unit can then make an Advance
move by moving a distance in inches less than or equal to this total, but no model can be moved within Engagement Range of enemy models. A unit cannot shoot or declare a charge in the same turn that it Advanced.
3
...
Unlike when making other types of move, models can move over enemy models when making a Fall Back move as if those enemy models were not there, but you must take a Desperate Escape test for each model that will do so (excluding models that are Tıᴛanıi or can Flt) before any models in that unit are moved. In addition, if a unit is Battle-shocked when it is selected to Fall Back, you must take a Desperate Escape test for every model in that unit before any are moved.
...
Back, but you must take Desperate Escape tests for them before they do so (excluding models that are Tıᴛanıi or can Flt).
■ If a Battle-shocked unit is selected to Fall Back,
take a Desperate Escape test for every model in that unit.
...
6"
The Sternguard Veterans are selected to make a Fall Back move, but to do so they must move through enemy models, so Desperate Escape tests
are required.
The controlling player rolls one D6 for each model that moves through an enemy unit, resulting in a 1, 2, 4, 4 and
6. Two models are therefore destroyed. 14
CORE RULES | MOVEMENT PHASE

1 MOVING OVER TERRAIN
Warhammer 40,000 battlefields are strewn with a wide variety of obstacles, structures and detritus collectively known as terrain features (see
pages 44-48). When a model makes any kind of move, it can be moved over a terrain feature but not through it (so models can’t move through a wall, for example, but can climb up or over it).
3 A model can be moved over terrain features that are 2" or less in height as if they were not there. A model can be moved vertically in order to climb up or down any terrain features that are taller than this, counting the vertical distance up and/or down as part of its move. Models cannot end any kind of move mid-climb – if it is not possible to end the move as a result, that move cannot be made.


The Von Ryan’s Leaper Advances towards the building. It moves a total of 9", moving freely over the pipe as it is only 2" in height.
The building is taller than 2" so the vertical distance of 3" must be counted as part of
the move. 3"


■ Models can move freely over terrain features 2" or less in height.
■ Models cannot move through terrain
features taller than 2", but can climb up and down them.
...
FLYING
If a model can Flt, then when it makes a Normal, Advance or Fall Back move, it can be moved over enemy models as if they were not there, and can be moved within Engagement Range of enemy models when making such a move. Note this also means that Monsᴛᴇʀ and Vᴇʜɪilᴇ models that can Flt can be moved over other Monsᴛᴇʀ and Vᴇʜɪilᴇ models when making such a move. However, models that can Flt cannot end their move on top of any other models or within Engagement Range of any enemy models.
When a model that can Flt starts or ends a move on a terrain feature, instead of measuring the path it has moved across the battlefield, you instead measure its path ‘through the air’, as shown in the diagram below.
...
■ Flt models can move over enemy models when they make a Normal, Advance or Fall Back move.
■ Flt models that start or end a move
on a terrain feature measure distance moved through the air when they make a Normal, Advance or Fall Back move.


In this example the Tyranid Prime makes a Normal move of 12" to end on top of the ruin. Because it can Flt it can move directly over the enemy Terminators as if they were not there, and it is the diagonal distance through the air that is measured.
...
Details of how to set up Reserves units are described in the same rules that enabled the unit to be set up in Reserves. These rules will typically specify a distance away from all enemy models; whenever such a distance is specified, it always
applies to the horizontal distance, even though normally you measure to and from the closest part of a model’s base.
...
Normal move in the turn they are set up on the battlefield.
■ Any specified distance from
enemy models applies to horizontal distance.
■ Any Reserves unit not set up on the
battlefield by the end of the battle counts as destroyed.
...
Some models have the Tʀansᴘoʀᴛ keyword. The following rules describe how units can embark within and disembark from such models, and how they are used to move these passengers across
the battlefield.
TRANSPORT CAPACITY
All Tʀansᴘoʀᴛ models have a transport capacity listed on their datasheet. This determines the type and maximum number of friendly models that can embark within them.
Units can start the battle embarked within a Tʀansᴘoʀᴛ model instead of being set up separately – declare which units are embarked within a Tʀansᴘoʀᴛ model before you set it up.


FIRING DECK
Some transports have firing hatches, ports or platforms from which embarked passengers can shoot.
Some Tʀansᴘoʀᴛ models have ‘Firing Deck x’ listed in their abilities. Each time such a model is selected to shoot in the Shooting phase, you can select up to ‘x’ models embarked within it. Then, for each of those embarked models, you can select one ranged weapon that embarked model is equipped with. Until that Tʀansᴘoʀᴛ model has resolved all of its attacks, it counts as being equipped with all of the weapons
you selected in this way, in addition to its other weapons.

■ Firing Deck ‘x’: Each time this Tʀansᴘoʀᴛ
shoots, select one weapon from up to ‘x’ models embarked within it; this
Tʀansᴘoʀᴛ counts as being equipped with those weapons as well.


EMBARK
If a unit makes a Normal, Advance or Fall Back move, and every model in that unit ends that move within 3" of a friendly Tʀansᴘoʀᴛ model, they can embark within it. A unit cannot embark if it has already disembarked from a Tʀansᴘoʀᴛ model in the same phase. Remove the unit from the battlefield and place it to one side – it is now embarked within that Tʀansᴘoʀᴛ model. Unless otherwise stated, units cannot do anything or be affected in any way while
17 they are embarked.

■ A unit can embark within a friendly Tʀansᴘoʀᴛ if all of its models end a Normal, Advance or Fall Back move within 3" of that Tʀansᴘoʀᴛ.
■ A unit cannot embark and disembark in the
same phase.

DISEMBARK
If a unit from your army starts your Movement phase embarked within a Tʀansᴘoʀᴛ model, that unit can disembark in that phase.
When a unit disembarks from a Tʀansᴘoʀᴛ model, set it up on the battlefield so that it is wholly within 3" of that Tʀansᴘoʀᴛ model and not within
Engagement Range of any enemy models. If, for any reason, a disembarking model cannot be set up, that model’s unit cannot disembark.
Units that disembark from a Tʀansᴘoʀᴛ model that either Remained Stationary this phase or has not yet made a Normal, Advance or Fall Back move this phase can then act normally (make a Normal move, Advance, shoot, declare a charge, fight, etc.) in the remainder of the turn. Such a disembarking unit cannot choose to Remain Stationary.
Units that disembark from a Tʀansᴘoʀᴛ model that made a Normal move this phase count as having made a Normal move themselves; they cannot move further during this phase. Such a unit also cannot declare a charge in the same turn, but can otherwise act normally in the remainder of the turn.
Units cannot disembark from a Tʀansᴘoʀᴛ model that either Advanced or Fell Back this turn.

■ Units that start your Movement phase embarked within a Tʀansᴘoʀᴛ can disembark this phase, provided their Tʀansᴘoʀᴛ has not Advanced or Fallen Back.
■ If a unit disembarks before its Tʀansᴘoʀᴛ
moves, it can act normally.
■ If a unit disembarks after its Tʀansᴘoʀᴛ
moves, it cannot move or charge this turn, but can otherwise act normally.
■ Disembarking units must be set up wholly
within 3" of their Tʀansᴘoʀᴛ and not within Engagement Range of any enemy models (or the unit cannot disembark).
■ Units that disembark this turn cannot
Remain Stationary.



CORE RULES | TRANSPORTS

DESTROYED TRANSPORTS
If a Tʀansᴘoʀᴛ model is destroyed, any units embarked within that Tʀansᴘoʀᴛ model must immediately disembark (see opposite) before that Tʀansᴘoʀᴛ model is removed from the battlefield.
Units that disembark from a destroyed Tʀansᴘoʀᴛ model are not affected by that model’s Deadly Demise ability (pg 23). Instead, you must roll one D6 for each disembarking model. For each roll of 1, that disembarking model’s unit suffers 1 mortal wound (pg 23). In addition, if a unit disembarks from a destroyed Tʀansᴘoʀᴛ model:
...
■ If a Tʀansᴘoʀᴛ is destroyed, any embarked units must disembark.
...
Command phase, the disembarking unit is Battle-shocked.
■ Until the end of the turn, the disembarking unit
counts as having made a Normal move, and cannot declare a charge.

Emergency Disembarkation
If a Tʀansᴘoʀᴛ model is destroyed and it is not possible to set up a disembarking unit wholly within 3" of that Tʀansᴘoʀᴛ model and not within Engagement Range of any enemy models, that unit must instead perform an Emergency
Disembarkation. This is performed as described for disembarking from a destroyed Tʀansᴘoʀᴛ model, except that a unit that does so must be set up wholly within 6" of the destroyed Tʀansᴘoʀᴛ model (instead of wholly within 3") and not within Engagement Range of any enemy models, and when rolling for each disembarking model, that unit suffers 1 mortal wound for each roll of 1-3 (instead of for each roll of 1). If, for any reason, a disembarking model still cannot be set up, that model is destroyed.
...
■ Units disembarking a destroyed Tʀansᴘoʀᴛ that cannot be set up wholly within 3" of it must perform an Emergency Disembarkation:
...
The Land Raider Crusader is destroyed, forcing the Terminators to disembark wholly within 3". The controlling player then rolls one D6 for
each disembarking model, resulting in a 1, 3, 3, 5 and 6. The Terminator 18
unit suffers 1 mortal wound and is now Battle-shocked.
CORE RULES | TRANSPORTS

1 SHOOTING PHASE
2 Guns thunder and shrapnel flies through the air. Bursts of muzzle flare and beams of las-fire illuminate
...
SELECT TARGETS
Each time a unit shoots, before any attacks are resolved, you must select the enemy units that will be the targets for all of the ranged weapons you wish its models to make attacks with. Each time you select a target for a model’s ranged weapon, you can only select an enemy unit as the target if at least one model in that unit is both within range of that weapon and visible to
that attacking model (pg 8). An enemy model is within range of a weapon if the distance between it and the attacking model is equal to or less than that weapon’s Range characteristic.
If a model has more than one ranged weapon, it can shoot all of them at the same target or it can shoot each of them at a
different target, but it cannot split attacks from the same weapon across more than one target. Similarly, if a unit has more than one model, those models can shoot at the same or different targets. In any case, when you select a target unit you must declare which models will target that unit with which weapons before any attacks are resolved. If any of these weapons have more than one profile that you must choose between, you must also declare which profile is being used.
...
the attacking model and within range of the weapon being used.
■ Models with more than one ranged weapon can shoot
them at the same or different targets, but models cannot split attacks from the same weapon across more than one target.
...
19 unit can only be selected as the target of a ranged attack if
the attacking model is within 12".

CORE RULES | SHOOTING PHASE

MAKE RANGED ATTACKS
The shooting unit’s models now make attacks using their ranged weapons. Each time a model shoots with a ranged weapon,
it will make a number of attacks equal to the Attacks (A) characteristic in that weapon’s profile. You make one Hit roll for each attack being made (see Making Attacks, pages 21-23).
...
Monsᴛᴇʀ and Vᴇʜɪilᴇ units are exceptions to these rules, as described in the Big Guns Never Tire section (see right).
...
Monsᴛᴇʀ and Vᴇʜɪilᴇ units are eligible to shoot in their controlling player’s Shooting phase even while they are within Engagement Range of one or more enemy units. Ranged weapons equipped by Monsᴛᴇʀ
and Vᴇʜɪilᴇ units can target one or more of the enemy units they are within Engagement Range of, even if other friendly units are also within Engagement Range of the same enemy unit. Each time a
Monsᴛᴇʀ or Vᴇʜɪilᴇ model makes a ranged attack, if its unit was within Engagement Range of one or more enemy units when it selected its targets, unless that attack is made with a Pistol (pg 25), subtract 1 from that attack’s Hit roll.
You can select an enemy Monsᴛᴇʀ or Vᴇʜɪilᴇ unit within Engagement Range of one or more units from your army as a target of ranged weapons. Each time a model from your army makes a ranged attack against such a target, unless that
attack is made with a Pistol, subtract 1 from that attack’s Hit roll.
Designer’s Note: A unit that is within Engagement Range of an enemy Monsᴛᴇʀ or Vᴇʜɪilᴇ unit is still not eligible to shoot, and so
cannot make ranged attacks against that Monsᴛᴇʀ or Vᴇʜɪilᴇ unit (unless that unit is eligible to shoot even while within Engagement Range of enemy units, e.g. it is itself a Monsᴛᴇʀ or Vᴇʜɪilᴇ unit, or its models are equipped with Pistols). Other units from your army that are eligible to shoot can, however, target and shoot that enemy Monsᴛᴇʀ or Vᴇʜɪilᴇ unit.


STEALTH
Some warriors are masters of disguise and concealment.
If every model in a unit has this ability, then each time a ranged attack is made against it, subtract 1 from that attack’s Hit roll.
■ Monsᴛᴇʀꜱ and Vᴇʜɪilᴇꜱ can shoot, and be shot at, even while they are within
Engagement Range of enemy units. Each time a ranged attack is made by or against such a unit, subtract 1 from that attack’s Hit roll (unless
shooting with a Pistol). 20
CORE RULES | SHOOTING PHASE
...
4 Use the following sequence to make attacks one at a time.
1
HIT ROLL
2
WOUND ROLL
...
An unmodified Wound roll of 6 is called a Critical Wound and is always successful. An unmodified Wound roll of 1 always fails. A Wound roll can never be modified by more than -1
or +1.
...
Some models have an invulnerable 4
...
■ An unmodified saving throw of 1 always fails. 22
...
Some attacks inflict mortal wounds. Each mortal wound inflicts one point of damage on the target unit, and they are always applied one
at a time. Do not make a Wound roll or saving throw (including invulnerable saving throws) against a mortal wound – just allocate it
as you would any other attack and inflict damage to a model in the target unit as described on the right.
Unlike damage inflicted by normal attacks, excess damage from mortal wounds is not lost if the damage can be allocated to another model. Instead, keep allocating damage to another model in the target unit until either all the damage has been allocated or the target unit
is destroyed.
If, when a unit is selected to shoot or fight, one or more of its attacks can inflict mortal wounds on the target, resolve any normal damage inflicted
5. INFLICT DAMAGE
...
by the attacking unit’s attacks on that target before inflicting any mortal
wounds on that target. If an attack

inflicts mortal wounds in addition to any normal damage, but the normal damage is subsequently saved, the target unit still suffers those mortal wounds, as described above.

■ Each mortal wound inflicted on a unit causes one model in that unit to lose one wound.
■ No saving throws can be
made against mortal wounds.
■ Mortal wounds inflicted by
attacks always apply after any normal damage, even if that damage was saved.
DEADLY DEMISE
From detonating ammo stores to corrosive innards or frenzied death throes, some targets are deadly even in defeat.
Some models have ‘Deadly Demise x’ listed in their abilities. When such a model is destroyed, roll one D6 before removing it from play (if such a model is a
Tʀansᴘoʀᴛ, roll before any embarked models disembark). On a 6, each unit within 6" of that model suffers a number of mortal wounds denoted by ‘x’ (if this is a random number, roll separately for each unit within 6").
Example: A Tʀansᴘoʀᴛ model with the Deadly Demise D3 ability is destroyed. Before any models disembark and before removing it from play, its controlling player rolls one D6, getting a 6. There are three units within 6" of that destroyed model, so its controlling player rolls one D3 for each of them, inflicting mortal wounds accordingly.

■ Deadly Demise x: When this model is destroyed, roll one D6. On a 6, each unit within 6" suffers
23 ‘x’ mortal wounds.
...
If the attacks being allocated to a target inflict random damage, you cannot use the fast dice rolling approach exactly as
stated above – you will need to roll the dice one at a time. Consider several attacks with a Damage characteristic of D3 being allocated to a target containing models with two wounds each. As excess damage is lost each time a model is destroyed, the order in which the attacks are allocated and resolved becomes important. If the results of those D3s were 1, then 2, then 3, the attacks would result in a total of two destroyed models, but applying them in the order 3, then 2, then 1 would result in two models being destroyed and a third being damaged with only one wound remaining.
...
1 As these weapons all have the same profile, the controlling player
chooses to use the fast dice rolling method.
Each has an Attacks characteristic of 1, so the controlling player rolls
2 twenty D6. Seven of the results are greater than or equal to the
Fleshborers’ Ballistic Skill of 4+, so seven hits are scored, and seven Wound rolls are then made.
The Strength characteristic of those attacks is 5, which is equal to the
3 Toughness of a Terminator, so rolls of 4+ are required to successfully
wound the target. Of those seven rolls, five successfully wound.
As all the attacks have a Damage characteristic of 1, and as the saving
4 throws required for the Terminators are all the same, the Space Marines
player can continue to use the fast dice rolling method and make all of those saving throws at the same time, even though strictly you should allocate attacks beforehand.
The attacks all have an Armour Penetration characteristic of -1, so in this
5 instance, even though the Terminators have an invulnerable saving throw,
their normal Save characteristic will afford them a better chance of survival. The saving throws rolled result in a 1, 2, 4, 5 and 5, meaning that two are failed.
The Space Marines player now has to allocate those two attacks, one at a
6 time. One Terminator model has already lost two wounds earlier in the
battle, so they must allocate attacks to that model first. This means that model loses its last remaining wound (Terminator models have a Wounds characteristic of 3), and is destroyed. The last attack is allocated to a
different model, and so that model suffers one wound. 24
CORE RULES | MAKING ATTACKS
...
Weapons with [ASSAULT] in their profile are known as Assault weapons. If a unit that Advanced this turn contains any models equipped with Assault weapons, it is still eligible to shoot in this turn’s Shooting phase. When such a unit is selected to shoot, you
can only resolve attacks using Assault weapons its models are equipped with.
...
Example: A model targets a unit that is within half range of a weapon with an Attacks characteristic
of 1 and the [RAPID FIRE 1] ability. That weapon therefore makes two attacks at the target, and you make two Hit rolls.
...
Weapons with [TWIN-LINKED] in their profile are known as Twin-linked weapons. Each time an attack is made with such a weapon, you can re-roll that
25 attack’s Wound roll.
...
When such a unit is selected to shoot, it can only resolve attacks using its Pistols and can only target one of the enemy units it is within Engagement Range of. In such circumstances, a Pistol can target an enemy unit even if other friendly units are within Engagement Range of the same enemy unit.
If a model is equipped with one or more Pistols, unless it is a Monsᴛᴇʀ or Vᴇʜɪilᴇ model, it can either shoot with its Pistols or with all of its other ranged weapons. Declare whether such a model will shoot with its Pistols or its other ranged weapons before selecting targets.

■ Can be shot even if the bearer’s unit is within Engagement Range of enemy units, but must target one of those enemy units.
■ Cannot be shot alongside any other non-Pistol
weapon (except by a Monsᴛᴇʀ or Vᴇʜɪilᴇ).
...
Example: An enemy unit is targeted by an attacking model equipped with a weapon with the [INDIRECT FIRE] ability. No models in the target unit are visible to the attacking model, so when resolving the attacks made with that weapon, subtract 1
from that attack’s Hit roll and each time an attack is allocated to a model in the target unit, it has the Benefit of Cover against that attack.
...
Weapons with [PRECISION] in their profile are known as Precision weapons. Each time an attack made with such a weapon successfully wounds an Attached unit (pg 39), if a Cʜaʀaiᴛᴇʀ model in that unit is visible
to the attacking model, the attacking model’s player can choose to have that attack allocated to that Cʜaʀaiᴛᴇʀ model instead of following the normal attack sequence.

■ When targeting an Attached unit, the attacking model’s player can have the attack allocated to a Cʜaʀaiᴛᴇʀ model in that unit visible to the bearer.
BLAST
...
within Engagement Range of any units from the attacking model’s army (including its own).

MELTA
Melta weapons are powerful heat rays whose fury is magnified at close range.
Weapons with [MELTA X] in their profile are known as Melta weapons. Each time an attack made with such a weapon targets a unit within half that
weapon’s range, that attack’s Damage characteristic is increased by the amount denoted by ‘x’.
Example: A model targets a unit that is within half range of a weapon with a Damage characteristic
of D6 and the [MELTA 2] ability. If that attack inflicts damage on the target, it inflicts D6+2 damage.
...
Weapons with [HEAVY] in their profile are known as Heavy weapons. Each time an attack is made with such a weapon, if the attacking model’s unit
Remained Stationary this turn, add 1 to that attack’s Hit roll.
■ Add 1 to Hit rolls if the bearer’s unit Remained 26
Stationary this turn.
CORE RULES | WEAPON ABILITIES

IMPERIAL REF: Weapon Designations FILE: 0-∆XE-15622100
Plasma gun
Heavy bolter
Plasma pistol Sniper rifle
...
Weapons with [HAZARDOUS] in their profile are known as Hazardous weapons. Each time a unit is selected to shoot or fight, if one or more models attack with Hazardous weapons, then after that unit has resolved all of its attacks, you must take one Hazardous
test for each Hazardous weapon that was just used by rolling one D6. For each roll of 1, that test is failed and one model in that unit equipped with
a Hazardous weapon is destroyed (selected by the controlling player), unless that model is a Cʜaʀaiᴛᴇʀ,
Monsᴛᴇʀ or Vᴇʜɪilᴇ, in which case it suffers 3 mortal wounds instead. Note that if you selected a Cʜaʀaiᴛᴇʀ model in an Attached unit, the mortal wounds suffered must be allocated to that model first, even if there is another model in that unit that has lost one or more wounds or has had attacks allocated to it this phase.
Example: A unit of five models make five attacks with ranged weapons with the [HAZARDOUS] ability. After the unit has finished shooting, its controlling player rolls five D6. One of the results is a 1, and as no models in the unit are Cʜaʀaiᴛᴇʀꜱ, Monsᴛᴇʀꜱ or Vᴇʜɪilᴇꜱ, one of those models is destroyed.

■ After a unit shoots or fights, roll one Hazardous test (one D6) for each Hazardous weapon used. For each 1, one model equipped with a Hazardous weapon is destroyed (Cʜaʀaiᴛᴇʀꜱ, Monsᴛᴇʀꜱ and Vᴇʜɪilᴇꜱ suffer 3 mortal wounds instead).

DEVASTATING WOUNDS
Some weapons can inflict strikes of such power that they make a mockery of armour and can cleave through several foes.
Weapons with [DEVASTATING WOUNDS] in their profile are known as Devastating Wounds weapons. Each
time an attack is made with such a weapon, a Critical Wound inflicts a number of mortal wounds on the target equal to the Damage characteristic of that weapon and the attack sequence ends.
...
Weapons with [EXTRA ATTACKS] in their profile are known as Extra Attacks weapons. Each time the bearer of such a weapon fights, it can make attacks with that weapon in addition to the one it chooses to fight with. The number of attacks made with
an Extra Attacks weapon cannot be modified by other rules.
...
1 CHARGE PHASE
2 Warriors hurl themselves into battle to slay with blade, hammer and claw. Strident war cries and frantic
screams echo through the whirling smoke as the moment of cataclysmic violence draws near.
3
In your Charge phase, if you have any eligible units from your army on the battlefield that you want to charge into close combat, you can select those units, one at a time, to declare
a charge. Each can only be selected once per phase. Once all of these charges (if any) have been resolved, progress to the
...
29 than or equal to the Charge roll, and must move into base-to-base
contact with an enemy model if possible.


CORE RULES | CHARGE PHASE
...
The Von Ryan’s Leaper declares a charge against the Eradicators, who are on top of a terrain feature 3" in height. The horizontal distance between the two units when the charge is declared is 4 1/2". To end
a Charge move within Engagement Range, the Tyranids player would need a Charge roll of 7 or higher.

CHARGING WITH FLYING MODELS
When a model that can Flt starts or ends a Charge move on a terrain feature, instead of measuring the path it has moved across the battlefield, you instead measure its path ‘through the air’. In addition, it can be moved over other models as if they were not there. A model that can Flt cannot end any move on top of another model.


■ Flt models can move over other models when they make a Charge move.
■ Flt models that start or end a Charge move
on a terrain feature measure distance moved through the air when they make a Charge move.
...
The Tyranid Prime is selected to declare a charge, and targets the Sternguard Veterans on top of the ruin. The Tyranids player rolls 10" for the Charge roll,
allowing the Tyranid Prime to move within Engagement Range of its target.
Note that as the Tyranid Prime can Flt, it can move over the Terminators, and the distance moved is the diagonal distance
through the air. 30
CORE RULES | CHARGE PHASE
...
FIGHT PHASE 1
Carnage engulfs the battlefield as the warring armies meet head-on. Fangs and claws crunch through 2
bone. Blades ring like hammers on anvils. Blood spurts and flesh tears as hate-filled foes tear one
another apart. 3
...
units with the Fights First ability that were not eligible to fight 32
at the start of the Fight phase, but have since become eligible to fight.
CORE RULES | FIGHT PHASE

1 FIGHT
When you select a unit to fight, it first Piles In, then its models make melee attacks, then the unit Consolidates.
3 1. PILE IN
When a unit Piles In, you can move each model in that unit that is not already in base-to-base contact with an enemy model up to 3" – this is a Pile-in move. For a Pile In to be possible,
a unit must be able to end these moves within Engagement Range of one or more enemy units and in Unit Coherency.
...
2
MAKE MELEE ATTACKS
Select weapon Select targets Make attacks
3
CONSOLIDATE
If these conditions cannot be met, no models in the unit can make Pile-in moves this phase and you progress to making melee attacks with that unit. Otherwise, the unit can make Pile-in moves.
...
enemy model, and in base-to-base contact with an enemy model if possible. The unit must end in Unit Coherency and within Engagement Range of at least one enemy unit (or no models can Pile In).
...
with another model from its own unit that is itself in base-to-base contact with an enemy unit.

SELECT WEAPON
When a model fights, it must do so using a melee weapon it is equipped with. The weapons a model is equipped with are
described on its datasheet. If a model has more than one melee weapon, it can only use one of them to make attacks with each
33 time it fights, so you must now declare which it will use before
resolving any of its attacks.

CORE RULES | FIGHT PHASE | FIGHT

If the selected weapon has more than one profile to choose between, a model can only use one of them to make attacks with each time it fights, so you must also declare which profile it will
use before resolving any of its attacks. 2
...
■ Each model that can fight does so using one of its 4
melee weapons.
...
Similarly, if a unit has more than one model, each model can make its attacks at the same, or different, targets. In either case, declare which attacks will target which units before any attacks are resolved.
...
of an enemy unit to target it, or in base-to-base contact with another model in its unit that is itself in base-to-base contact with that enemy unit.
...
Note that all of the attacks you have declared targets for are 34
always resolved against the target units, even if, when you come to resolve an attack, no models in the target unit of that attack
CORE RULES | FIGHT PHASE | FIGHT
...
If a unit can end its Consolidation within Engagement Range of one or more enemy units, then each time one of its models makes a Consolidation move, it must end that move closer
to the closest enemy model. If it can also end that move in base-to-base contact with one or more enemy models while still satisfying all of the conditions above, it must do so.
...
The Termagant unit is selected to fight. First, the unit Piles In and all of its models move up to 3" in order to end closer to the closest enemy model, and in
base-to-base contact if they can. Note that two Termagants are already in base-to-base contact with the foe – these models therefore do not move.
...
After the Termagants have made all of their attacks, one enemy model has been destroyed. The Termagants now Consolidate; just like when they Piled In, each model must move up to 3" in order to end closer to the closest enemy
model, and in base-to-base contact if they can. Three Termagants are already in base-to-base contact, and so are 36
not moved.
CORE RULES | FIGHT PHASE | FIGHT
...
Wounds (W): Wounds represent how much damage a model can sustain before it succumbs to its injuries. If a model’s
Wounds characteristic is reduced to 0, that model is destroyed.
...
3 ABILITIES
Many units have special abilities and rules that may apply during the game, from Core Rules shared by many units to bespoke Psychic abilities and invulnerable saves.
These will be described here, along with any rules that apply when larger models such as vehicles have suffered sufficient damage.
Some abilities are bestowed by items of wargear that models in a unit can be
equipped with, and are known as Wargear abilities. These only apply while a model in the unit is equipped with the relevant item of wargear.
4 WEAPONS
...
This section details the number and types of models in the unit, and the default weapons and wargear those models are equipped with. It may also describe other interactions, such as how units with the Leader ability can attach to other units, and passenger restrictions that may apply to Tʀanꜱᴘoʀᴛ models.

7 WARGEAR OPTIONS
Some datasheets have a bullet-pointed list of wargear options. When you include
such a unit in your army, you can use these options to change the weapons and other wargear of models in the unit. The order you use these options in does not matter, but each can only be used once.


LEADERSHIP TESTS
If a rule requires you to take a Leadership test for a unit, roll 2D6: if the total is greater than or equal to the best Leadership characteristic in that unit, that test is passed.
Otherwise, it is failed.
RANDOM CHARACTERISTICS
Some characteristics are a random value instead of a number.
For example, a model’s Move characteristic might be 2D6", or a weapon’s Attacks characteristic might be D6. When a unit with a random Move characteristic is selected to move, determine the entire unit’s move distance by rolling the indicated number of
dice. For all other characteristics, roll to determine the value on
an individual, per-model or
per-weapon basis each time that characteristic is required.
AURA ABILITIES
Some abilities affect multiple models or units in a given range. These
are known as Aura abilities and are tagged with the word ‘Aura’. A
model with an Aura ability is always within range of its own Aura ability. A unit can be affected by more than one Aura ability at a time, but if
a unit is within range of the same Aura ability more than once, that Aura ability only applies to that unit once.
PSYCHIC WEAPONS AND ABILITIES
Some weapons and abilities can only be used by Pꜱtᴋᴇʀꜱ. Such weapons and abilities are tagged with the word ‘Psychic’. If a Psychic weapon or ability causes any unit to suffer one or more wounds, each of those wounds is considered to have been inflicted by a Psychic Attack.
...
During the Declare Battle Formations step, if every model in a unit has this ability, you can set it up in Reserves instead of setting it up on the battlefield. If you do, in the Reinforcements step of one of your
...
step, more than 9" horizontally away from all enemy models.


SCOUTS
Scouts form the vanguard of many armies. Unnoticed by the enemy, they range ahead of the main force.
Some units have ‘Scouts x"’ listed in their abilities. If every model in a unit has this ability, then at the start of the first battle round, before the first turn begins, it can make a Normal move of up to x" as if it were your Movement phase – as can any Dᴇdıiaᴛᴇd Tʀanꜱᴘoʀᴛ model such a unit starts the
battle embarked within (provided only models with this ability are embarked within that Dᴇdıiaᴛᴇd Tʀanꜱᴘoʀᴛ model). A unit that moves using this ability must end that move more than 9" horizontally away from all enemy models. If both players have units that can do this, the player who is taking the first turn moves their units first.
...
■ If embarked in a Dᴇdıiaᴛᴇd Tʀanꜱᴘoʀᴛ,
that Dᴇdıiaᴛᴇd Tʀanꜱᴘoʀᴛ can make this move instead.
39 ■ Must end this move more than 9" horizontally
...
During deployment, if every model in a unit has this ability, then when you set it up, it can be set up anywhere on the battlefield that is more than 9"
horizontally away from the enemy deployment zone and all enemy models.

LEADER
Mighty heroes fight at the forefront of battle.
Some Cʜaʀaiᴛᴇʀ units have ‘Leader’ listed on their datasheets. Such Cʜaʀaiᴛᴇʀ units are known as Leaders, and the units they can lead – known as their Bodyguard units – are listed on their datasheet.
During the Declare Battle Formations step, for each Leader in your army, if your army also includes one or more of that Leader’s Bodyguard units, you can select one of those Bodyguard units. That Leader will then attach to that Bodyguard unit for the duration of the battle and is said to be leading that unit. Each Bodyguard unit can only have one Leader attached to it.
While a Bodyguard unit contains a Leader, it is known as an Attached unit and, with the exception of rules that are triggered when units are destroyed (pg 12), it is treated as a single unit for all rules purposes. Each time an attack targets an Attached unit, until the attacking unit has resolved all of its attacks, you must use the Toughness characteristic of the Bodyguard models in that unit, even if a Leader in that unit has a different Toughness characteristic. Each time an attack sucessfully wounds an Attached unit, that attack cannot be allocated to a Cʜaʀaiᴛᴇʀ model in that unit, even if that Cʜaʀaiᴛᴇʀ model
has lost one or more wounds or has already had attacks allocated to it this phase. As soon as the last Bodyguard model in an Attached unit has been destroyed, any attacks made against that unit that have yet to be allocated can then be allocated to Cʜaʀaiᴛᴇʀ models in that unit.

■ Before the battle, Cʜaʀaiᴛᴇʀ units with the Leader ability can be attached to one of their Bodyguard units to form an Attached unit.
■ Attached units can only contain one Leader.
■ Attacks cannot be allocated to Cʜaʀaiᴛᴇʀ
models in Attached units.

CORE RULES | DEPLOYMENT ABILITIES
...
When you use a Stratagem, reduce your CP total by the amount listed on that Stratagem. If you do not have enough CP for a specific Stratagem, you cannot use it. You can use the same Stratagem multiple times during a battle, but you
cannot use the same Stratagem more than once in the same phase.

■ To use a Stratagem you must pay the CP specified.
■ The same Stratagem cannot
be used more than once in the same phase.
...
WHEN: Fight phase, when a Cʜaʀaiᴛᴇʀ unit from your army that is within Engagement Range of one or more Attached units is selected to fight.
TARGET: One Cʜaʀaiᴛᴇʀ model in your unit.
...
TARGET: The unit from your army that Battle-shock test was just taken for (even though your
Battle-shocked units cannot normally be affected by your Stratagems).
...
TARGET: One Gʀᴇnadᴇꜱ unit from your army that is not within Engagement Range of any enemy units and has not been selected to shoot this phase.
EFFECT: Select one enemy unit that is not within Engagement Range of any units from your army and is within 8" of and visible to your Gʀᴇnadᴇꜱ unit.
Roll six D6: for each 4+, that enemy unit suffers 1 mortal wound.

TANK SHOCK
CORE – STRATEGIC PLOY STRATAGEM
Ramming the foe with a speeding vehicle may be an unsubtle tactic, but it is a murderously effective one.
WHEN: Your Charge phase.
TARGET: One Vᴇʜɪilᴇ unit from your army.
EFFECT: Until the end of the phase, after your unit ends a Charge move, select one enemy unit within Engagement Range of it, then select one melee weapon your unit is equipped with. Roll a number of D6 equal to that weapon’s Strength characteristic.
If that Strength characteristic is greater than that enemy unit’s Toughness characteristic, roll two additional D6. For each 5+, that enemy unit suffers 1 mortal wound (to a maximum of 6 mortal wounds).
...
TARGET: One Infanᴛʀt unit from your army that was selected as the target of one or more of the attacking unit’s attacks.
...
WHEN: Your opponent’s Shooting phase, just after an enemy unit has selected its targets.
TARGET: One Smoᴋᴇ unit from your army that was selected as the target of one or more of the attacking unit’s attacks.
...
RESTRICTIONS: You can only select a Vᴇʜɪilᴇ unit
from your army if it is a Walᴋᴇʀ. Note that even if 42
this charge is successful, your unit does not receive any Charge bonus this turn (pg 29).
CORE RULES | STRATAGEMS
...
These rules let you place units into Strategic Reserves – a special type of Reserves you can use to keep units off the battlefield until you require them. Note that while all Strategic Reserves units are also technically Reserves units, the reverse is not true, and so these rules do not apply to units that are using other
rules that enable them to start the battle in Reserves (e.g. Deep Strike). Such units are instead set up as described by those other rules.
PLACING UNITS INTO STRATEGIC RESERVES
Before the battle, when you are instructed to Declare Battle Formations, you can select one or more units from your army to be placed into Strategic Reserves (excluding Foʀᴛɪfıiaᴛɪonꜱ).
The combined points value of all the units you wish to place into Strategic Reserves before the battle (including those embarked within Tʀanꜱᴘoʀᴛ models that are themselves placed into Strategic Reserves) cannot exceed 25% of your total points limit for your chosen battle size, as shown in the table below.
STRATEGIC RESERVES
MAXIMUM COMBINED POINTS VALUE OF UNITS THAT CAN
...
■ During the second battle round, Strategic Reserves units that arrive must be set up wholly within 6" of any battlefield edge, but no model in those units

BATTLE SIZE
BE PLACED INTO STRATEGIC RESERVES BEFORE
...
■ Combined points value cannot exceed 25% of
your army’s total.
■ Cannot put Foʀᴛɪfıiaᴛɪonꜱ into
Strategic Reserves.
Reserves units that arrive must be set up wholly
within 6" of any battlefield edge.
In any case, Strategic Reserves units cannot be set up within 9" horizontally of any enemy models. All
other rules that apply when setting up Reserves units also apply when setting up Strategic Reserves units.
...
Battlefields are populated with terrain features that your models will need to move over or around, and which can partially or fully block line of sight between models. The rules on the following pages apply to the most common terrain features on the
battlefields of the 41st Millennium. Unless otherwise stated, models can move up, over and down terrain features following the normal rules for movement.
...
much-needed shelter from enemy salvoes. Even heavily armoured warriors unfazed by small arms fire are thankful for such cover when foes bring their biggest guns to bear.
...
BENEFIT OF COVER
Each time a ranged attack is allocated to an Infanᴛʀt model that is wholly on top of this terrain feature, that model has the Benefit of Cover against that attack.
KEYWORDS: Aʀᴇa Tᴇʀʀaın, Cʀaᴛᴇʀ
...
BENEFIT OF COVER
Each time a ranged attack is allocated to an Infanᴛʀt model that is wholly within 3" of this terrain feature, if that model is not fully visible to every model in the
attacking unit because of this terrain feature, that model has the Benefit of Cover against that attack.
45
KEYWORDS: Obꜱᴛailᴇ, Baʀʀɪiadᴇ
...
KEYWORDS: Obꜱᴛailᴇ, Baᴛᴛlᴇfɪᴇld Dᴇʙʀɪꜱ
...
MOVEMENT
These terrain features are raised areas that models can be set up on top of or end a move on top of, provided the model’s base does not overhang the terrain feature (if the model does not have a base, no part of that model that would be in contact with the battlefield
at ground level can overhang that terrain feature). In addition, other terrain features can be set up on top of a Hɪll terrain feature, provided no part of those terrain features overhangs that Hɪll terrain feature.
VISIBILITY
Normal visibility rules apply.
BENEFIT OF COVER
Each time a ranged attack is allocated to a model, if that model is not fully visible to every model in the attacking unit because of this terrain feature, that model has the Benefit of Cover against that attack.
...
FOOTPRINT
When this terrain feature is set up on the battlefield, both players must agree upon its footprint – that is, the boundary of the terrain feature at ground level. This is so that players know when a model is wholly within this terrain feature. If this terrain
feature is mounted on a base, then this will define its footprint.
MOVEMENT
Models can be moved over this terrain feature, as described on page 15.
VISIBILITY
Models and units that are wholly within this terrain feature are never considered to be fully visible to an observing model. Similarly, if a model that is not wholly within this terrain feature must look through or over this terrain feature in order to draw line
of sight to another model, then that other model is never considered to be fully visible to that observing model, and so it will have the Benefit of Cover from this terrain feature. Aɪʀiʀafᴛ and Towᴇʀɪng models are exceptions to this – visibility to and from such models is determined normally,
even if this terrain feature is wholly in between them and the observing model. Models that are wholly within this terrain feature can see out of
it normally.
BENEFIT OF COVER
...
vertically from ground level, and every model in the target unit is at ground level, improve the Armour Penetration characteristic of that attack by 1.
MOVEMENT
• Infanᴛʀt and Bᴇaꜱᴛ models can move through this terrain feature (walls, floors, ceilings, gantries, chains, etc.) as if it were not there. A model cannot end a move within a wall, a floor, etc.
• Infanᴛʀᴛ, Bᴇaꜱᴛꜱ and Flᴛ models can be set up or end a move on any floor level of this terrain feature, but if that level is not the ground floor, such models can only do so if their base does not overhang the floor at that level (if a model does not have a base, no part of that model that would be in contact with the battlefield at ground level can overhang that floor). All other models can only be set up or end a move on the ground floor of this terrain feature.
VISIBILITY
Models cannot see over or through this terrain feature (i.e. a unit outside this terrain feature cannot draw line of sight to a target on the other side of it, even if it would be possible to draw line of sight to that target through open windows, doors, etc.). Aɪʀɪʀafᴛ and Towᴇʀɪng models are exceptions to this – visibility to and from such models is determined normally,
even if this terrain feature is wholly in between them and the observing
model. Models can see into this terrain feature normally, and models that are wholly within this terrain feature can see out of it normally.
BENEFIT OF COVER
Each time a ranged attack is allocated to a model, if that model is either wholly within this terrain feature, or it is not fully visible to every model in the attacking unit because of this terrain feature, that model has the Benefit of Cover against that attack.


KEYWORDS: Aʀᴇa Tᴇʀʀaɪn, Ruɪnꜱ
...
Battlefields are typically created by placing Battlezones next to each other. Battlezones are Citadel terrain sets that include two boards (each approximately 22" by 30" in size) and a range of terrain features designed to be set up evenly on those boards for the best Warhammer 40,000 gaming experience. Don’t worry if your battlefield doesn’t match these requirements, but keep in mind that playing
on a battlefield that is either a barren wasteland or filled to overflowing with terrain features may give an advantage to one side or the other.
Below is an example of a battlefield set up for a Strike Force battle, with a good mixture of different terrain features
fairly distributed across the battlefield. Their placement will create a dynamic gaming experience that doesn’t favour one player over the other.
Importantly, some terrain features that block visibility have been placed near the middle of the battlefield, ensuring that it is not easy to see from one side of the battlefield
to the other. Battlefields where this is not the case can advantage armies that rely on shooting, or disadvantage armies that rely on melee. There is also sufficient room for larger models such as vehicles to manoeuvre around the terrain features, especially near the edges, without getting trapped.
...
49 placement creates a battlefield that does not give an advantage to one player or the other, making it well suited to an aspirational matched play game. While this battlefield uses lots of Battlezone: Fronteris terrain features, you could achieve the same gaming experience using many
different kinds of terrain, bearing in mind the concepts discussed above.


CORE RULES | EXAMPLE BATTLEFIELDS
...
Narrative Play Focused: This Strike Force battlefield has an ideal number and mixture of terrain features. The largest pieces of Aʀᴇa Tᴇʀʀaɪn have been set up along the two long battlefield edges, while the middle of the battlefield only has a scattering of Obꜱᴛaɪlᴇꜱ to provide any kind of shelter from enemy fire. While this battlefield is not ideal for a matched play game, it would make for a very thematic set-up for a narrative play game.
...
Some models have the Aɪʀɪʀafᴛ keyword. The following rules describe how such models operate on the battlefield.
DEPLOYING AIRCRAFT
When you are instructed to Declare Battle Formations, Aɪʀɪʀafᴛ models must start the battle in Reserves instead of being set up on the battlefield. Once the battle has started, Aɪʀɪʀafᴛ models are then treated as Strategic Reserves units for all rules purposes (pg 43). Only units that are themselves placed into Reserves can start the battle embarked within Aɪʀɪʀafᴛ Tʀanꜱᴘoʀᴛ models that are
in Reserves.


HOVER
Some aircraft can use vectored thrusters or anti-grav technology to hover over the
battlefield, the better to hunt their prey or deploy embarked troops.
Some Aɪʀɪʀafᴛ models have ‘Hover’ listed in their abilities. When you are instructed to Declare Battle Formations, before doing anything else, you must first declare which
models from your army with this ability will be in Hover mode.
If a model is in Hover mode, then until the end of the battle, its Move characteristic is changed to 20", it loses the Aɪʀɪʀafᴛ keyword and it loses all associated rules for being an Aɪʀɪʀafᴛ model. Models in Hover mode do not start the battle in Reserves, but you can choose to place them into Strategic Reserves following the normal rules if you wish.
AIRCRAFT IN THE MOVEMENT PHASE
Aɪʀɪʀafᴛ models cannot Advance, Fall Back or Remain Stationary. If, when an Aɪʀɪʀafᴛ model is selected to move in the Movement phase, any
enemy units are within Engagement Range of it, that
Aɪʀɪʀafᴛ model can still make a Normal move.
Each time an Aɪʀɪʀafᴛ model makes a Normal move, first move the model straight forward, and it must move a minimum of 20" – all parts of the model’s base must end the move at least this far from where they started. After it has moved, it can pivot on the spot up to 90° – this does not contribute to how far the model moves. If, when making a Normal move, any part of an Aɪʀɪʀafᴛ model’s base crosses the edge of the battlefield, or it cannot move a minimum of 20", that model’s move ends and it is placed into Strategic Reserves. There is no upper limit to how
far Aɪʀɪʀafᴛ models can move, and their Move characteristic is therefore 20+".
If placed into Strategic Reserves, an Aɪʀɪʀafᴛ model will always arrive from Strategic Reserves in your next turn.

■ Aɪʀɪʀafᴛ can only make a Normal move, and can do so even when within Engagement Range of enemy models.
■ Aɪʀɪʀafᴛ must move straight forward at least
20", and can then make one pivot of up to 90°.
■ Aɪʀɪʀafᴛ that cross the edge of the battlefield,
or that cannot make their minimum move, are placed into Strategic Reserves.
...
When a unit is selected to move in the Movement phase, if the only enemy models that are within Engagement Range of that unit are Aɪʀɪʀafᴛ models, then that unit can still make a Normal or Advance move.
Whenever a model makes any kind of move, it can be moved over enemy Aɪʀɪʀafᴛ models as if they were not there, and can be moved within Engagement Range of enemy Aɪʀɪʀafᴛ models, but it cannot end that move on top of another
model or within Engagement Range of any enemy
Aɪʀɪʀafᴛ models.

■ Units can still make a Normal or Advance move if they are only within Engagement Range of enemy Aɪʀɪʀafᴛ.
■ Models can move within Engagement Range of
enemy Aɪʀɪʀafᴛ, but cannot end a move within Engagement Range of enemy Aɪʀɪʀafᴛ.
■ Models can move over Aɪʀɪʀafᴛ when they
make any kind of move.
AIRCRAFT IN THE CHARGE AND FIGHT PHASES
Aɪʀɪʀafᴛ units cannot declare a charge, and only units that can Flᴛ can select an Aɪʀɪʀafᴛ unit as a target of their charge. Such units can end their
Charge move within Engagement Range of one or more enemy Aɪʀɪʀafᴛ units.
An Aɪʀɪʀafᴛ model is only eligible to fight if it is within Engagement Range of one or more enemy units that can Flᴛ, and it can only make melee attacks against units that can Flᴛ. Only models that can Flᴛ can make melee attacks against Aɪʀɪʀafᴛ units.
Aɪʀɪʀafᴛ models cannot make Pile-in or Consolidation moves. Each time a model makes a Pile-in or Consolidation move, unless that model can Flᴛ, Aɪʀɪʀafᴛ models are ignored for the purposes of moving closer to the closest enemy model.

■ Only units that can Flᴛ can charge at or make melee attacks against Aɪʀɪʀafᴛ.
■ Aɪʀɪʀafᴛ cannot charge, Pile In or Consolidate,
and can only make melee attacks against units that can Flᴛ.
■ When a model Piles In or Consolidates, unless it
can Flᴛ, ignore Aɪʀɪʀafᴛ when determining the closest enemy model.
...
The Stormtalon Gunship begins the Movement phase within Engagement Range of the Tyranid Prime. The Stormtalon is an Aɪʀɪʀafᴛ model and is not in Hover mode, so is free to make a Normal move.
The Stormtalon must move a minimum of 20" straight forward, even though this would bring it within Engagement Range of an enemy unit.
After finishing its Normal move, the Stormtalon can then pivot on the spot up to 90º.
...
With your opponent, select one of the battle sizes below. This will determine the total number of points each player can spend to build their army and, as a result,
how long the battle will last. Points are a measure of a unit’s power on the battlefield; the higher a unit’s points value, the more powerful that unit is. The points values for units are presented in other publications, such as Codexes and the Munitorum Field Manual. You will need to refer to these when building your army.

INCURSION
Points per Army 1000
Duration Up to 2 hours
The details of your army must be recorded on an Army Roster. This can be written on a piece of paper or recorded using the Warhammer 40,000 app. Players must show their finished Army Roster to their
opponent before battle commences.
...
Select all the units you want to include in your army. Your army must include at least one Cʜaʀaɪᴛᴇʀ unit. Each time you
include a unit in your army, it can take any upgrade, Enhancement or options it has access to. Note on your Army Roster the number of models in the unit, any weapons, wargear, upgrades and any Enhancement it has, and its points value. Subtract this points value from the total permitted for your battle size.
...
■ Your army does not already contain three units with the same datasheet name as that unit – or six units with the same datasheet name as that unit if
it is a Baᴛᴛlᴇlɪnᴇ or Dᴇdɪɪaᴛᴇd Tʀanꜱᴘoʀᴛ* unit.

Only Cʜaʀaɪᴛᴇʀꜱ can be given Enhancements and your army cannot include more than three Enhancements in total. No unit can have more than one Enhancement and each Enhancement included in your army must be unique.
Eᴘɪɪ Hᴇʀoᴇꜱ cannot be given any Enhancements. Your army cannot include the same Eᴘɪɪ Hᴇʀo more than once.
* Every Dᴇdɪɪaᴛᴇd Tʀanꜱᴘoʀᴛ unit from your army must start the battle with at least one unit embarked within it, or it cannot be deployed for that battle and will instead count as having been destroyed during the first battle round.
Select one Cʜaʀaɪᴛᴇʀ model from your army to be your Warlord – this will be the leader of your army – and make a note of this on your Army Roster. Your Warlord gains the Waʀloʀd keyword.
...
1
MUSTER ARMIES
Players muster their armies based on their selected battle size, as described on pages 55-56. Each mission will guide
4
...
players on what size of battle they can play, and may include

further rules that could affect how players pick their armies.

2
READ MISSION OBJECTIVES
Each mission will state what its primary objectives are, and may also include one or more special rules. These cover unique situations, or abilities that can be
used in the battle.
...
■ Which of their units will start the battle embarked within Tʀanꜱᴘoʀᴛ models (they must specify which units are embarked within which models).
...
9
BEGIN THE BATTLE
The first battle round begins. Players continue to complete battle rounds until the
battle ends.

10
END THE BATTLE
Each mission will tell you when the battle ends. This will typically be after a set number of battle

must be set up, and will provide details of where to set them up.
rounds have been completed, or when one player has achieved a

Otherwise, it is assumed you are using the guidelines on pages 49-52 to create your battlefield. If you are using a battlefield that is a different size or shape to
those guidelines, you will need to adjust distances, and the location of deployment zones, objective markers and terrain features, in an appropriate way.
6
DEPLOY ARMIES
...
When setting objective markers up on the battlefield, place them so they are centred on the point specified by the mission. When measuring distances to and from objective markers, measure
to and from the closest part of them. Models can move over objective markers as if they were not there, but they cannot end a move on top of an objective marker.
...
To control an objective marker, a player will first need to move models within range of it. A model is within range of an
objective marker if it is within 3" horizontally and 5" vertically of that objective marker.
Every model has an Objective Control (OC) characteristic listed on its datasheet. To determine a player’s Level of Control over an objective marker, add together the OC characteristics of all the models from that player’s army that are within range of that
objective marker. A player will control an objective marker at the end of any phase if their Level of Control over it is greater than their opponent’s. If both players have the same Level of Control over an objective marker, that objective marker is contested.
...
If it is not possible to set up terrain features or objective markers in this way, and both players agree, you can nudge the positions of
any terrain feature or objective marker so that these conditions are satisfied. Of course, the final position of an objective marker should
still be as close as possible to the location indicated on your mission’s deployment map, but if both players are happy to tweak the battlefield arrangement to forge a stronger narrative, you should feel free to
do so.
...
CORE RULES | MISSIONS | OBJECTIVE MARKERS
...
Players now create the battlefield and set up terrain features using the guidelines on pages 49-52. The minimum size of your battlefield depends on
the battle size you have selected, as shown in the table below.
BATTLEFIELDS
MINIMUM
BATTLEFIELD SIZE
...
CORE RULES | MISSION: ONLY WAR

6 DEPLOY ARMIES
Players then alternate deploying their units, one at a time, starting with the Attacker. Models must be set up wholly within their controlling player’s deployment zone. Continue setting up units until both players have set up all the units from their
armies, or you have run out of room to set up more units. If one player has finished setting up their army, their opponent continues to set up the remaining units from their army.
...
INSERT INTO public.game_sessions (is_active, created_at, rule_set_id, game_name, game_state, clerk_user_id) VALUES (true, '2025-09-22 12:34:56.000000', 3, 'Warhammer 40.000', 'playing', 'user_338ZBr9iJtu7LwsZBjtDSHdArrk');

INSERT INTO public.game_players (created_at, session_id, player_name) VALUES ('2025-09-22 12:34:56.000000', 3, 'Aki');
INSERT INTO public.game_players (created_at, session_id, player_name) VALUES ('2025-09-22 12:34:56.000000', 3, 'Jack');
INSERT INTO public.game_players (created_at, session_id, player_name) VALUES ('2025-09-22 12:34:56.000000', 3, 'Michaela');
