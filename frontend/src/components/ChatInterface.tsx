...
export const ChatInterface: React.FC<ChatInterfaceProps> = ({ sessionId }) => {
  ...
  return (
    <div className="flex flex-col h-full bg-black border border-gray-800 rounded-lg min-h-0">
      ...
      {/* Error Display */}
      {error && (
        <div className="p-2 lg:p-3 bg-red-900/20 border-b border-red-800 flex-shrink-0">
      ...
      <div className="flex-1 overflow-y-auto p-3 lg:p-4 space-y-3 lg:space-y-4 min-h-0">
        {isLoading && chatEntries.length === 0 ? (
          ...
          chatEntries.map((entry) => (
            ...
            >
              <div
                className={`max-w-[280px] lg:max-w-md px-3 py-2 lg:px-4 lg:py-2 rounded-lg ${
              ...
              >
                ...
                <p className="text-xs lg:text-sm">{entry.content}</p>
                <p
        ...
        {isWaitingForAI && (
          <div className="flex justify-start">
            <div className="max-w-[280px] lg:max-w-md px-3 py-2 lg:px-4 lg:py-2 rounded-lg bg-gradient-to-r from-gray-800 to-gray-900 text-white border border-gray-700">
              <div className="text-xs font-medium mb-1 flex items-center">
      ...
      {/* Message Input */}
      <div className="p-3 lg:p-4 border-t border-gray-800 flex-shrink-0">
        <form onSubmit={handleSendMessage} className="flex space-x-2">
          <input
            ...
            className="flex-1 px-3 py-2 border border-gray-700 rounded-md focus:outline-none focus:ring-2 focus:ring-[#3076F9] focus:border-transparent bg-gray-800 text-white placeholder-white/50 text-sm lg:text-base"
          ...
          <button
            ...
            className="px-3 py-2 lg:px-4 lg:py-2 bg-gradient-to-r from-[#F930C7] to-[#3076F9] text-white rounded-md hover:from-[#F930C7]/80 hover:to-[#3076F9]/80 disabled:opacity-50 disabled:cursor-not-allowed transition-colors text-sm lg:text-base"
          >
